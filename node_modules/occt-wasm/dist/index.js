...
export class OcctKernel {
     ...
     * adjacent to `edge`.
     * @throws OcctError */
    chamferAsymmetric(solid, edge, distance1, distance2, referenceFace) {
        return wrap("chamferAsymmetric", () => handle(this.#raw.chamferAsymmetric(solid, edge, distance1, distance2, referenceFace ?? 0)));
    }
    /**
